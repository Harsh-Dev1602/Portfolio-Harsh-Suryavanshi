...
function ContactUs() {
  ...
  return (
    <>
      <main name="Contact Me" className="w-full h-auto  py-10 ">

        <h1 className=" text-2xl text-white rounded-md p-2  font-bold inline BG_Color">Contact me</h1>

        <section className="mt-5">
          <span className=" text-md">Please fill out the form below to contact me</span>
          <form onSubmit={handleSubmit(onSubmit)}
            ...
            <div>
              <label htmlFor="name" className="block font-bold text-lg Text_Color">Name</label>
            ...
            <div>
              <label htmlFor="email" className="block Text_Color font-bold text-lg">Email</label>
            ...
            <div>
              <label htmlFor="message" className="block Text_Color font-bold text-lg">Message</label>
            ...
            <button type="submit" className="BG_Color cursor-pointer text-white py-3 px-6 rounded-md font-bold">Send Message</button>
          </form>
        </section>
      </main>
    </>
